 ...
 */
package de.adesso.wickedcharts.wicket;
...
public class JavaScriptResourceRegistry {
	...
	public class RegistryEntry {
		...
		public RegistryEntry() {
			// must be replaced via setter later on
		}
	...
	private RegistryEntry jqueryEntry = new RegistryEntry(JQueryResourceReference.getV3());

	private RegistryEntry highchartsEntry = new RegistryEntry();

	private RegistryEntry funnelEntry = new RegistryEntry();

	private RegistryEntry heatmapEntry = new RegistryEntry();

	private RegistryEntry highchartsExportingEntry = new RegistryEntry();

	private RegistryEntry highchartsMoreEntry = new RegistryEntry();

	private RegistryEntry chartJsEntry = new RegistryEntry();

	private RegistryEntry chartJsBundleEntry = new RegistryEntry();

	private RegistryEntry momentJsEntry = new RegistryEntry();
	 ...
	 *
	 * @param reference
	 *                     reference a Resource to be used
	 */
